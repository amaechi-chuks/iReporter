...
chai.use(chaiHtpp);
describe('Test user register routes', () => {
  describe('/POST api/v1/auth/register', () => {
    it('should register a new user if details are correct', (done) => {
      const data = {
        ...
        lastname: 'Amaechi',
        othernames: 'love',
        email: 'amaechichuksg2000@yahoo.com',
        password: 'fabulous26',
        phonenumber: '0706859552',
        username: 'ChuksAmaech',
      };
      chai.request(app)
    ...
    //   //       lastname: 'Amaechi',
    //   //       othernames: '',
    //   //       email: 'amaechichuks2000@yahoo.com.com',
    //   //       phonenumber: '07068566559',
    //   //       username: 'ChuksAmaechi',
    //   //       password: '07068566559',
    //   //     })
    //   //     .end((err, res) => {
